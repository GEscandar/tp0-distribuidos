...
- Se agrega el envío de un byte de método antes del payload, para representar distintas operaciones.
- Se agrega el método `WINNERS` para obtener la lista de ganadores.
